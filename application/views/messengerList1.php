...
<div style=" width: 61%; background: #fff;position:absolute; left:362px;top:46px;height: 92%; ">
 <div id="cbox" style="height: 100%;">
   <div style="">
    <br>
        <h3 style="margin-left: 5px;color: #999; "> Nothing to show </h3>
     </div>
</div>
</div>
