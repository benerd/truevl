...
<meta property="og:description" content=" <?php echo $value->short_des; ?>" />
<meta property="og:image" content="<?php echo base_url().$value->img; ?>" />
...
<header >
  ...
  <div id="left">  <h1> <a href="<?php echo base_url(); ?>" class="tn"> truevl </a> </h1> 
...
<?php if($this->session->userdata("email")) { ?>
   ...
   <div id="centerSrch"> 
   <div class="headerIco">
    <a href="<?php echo base_url(); ?>" class="home nic1 margin6">  
...
<div class="promo_noti3"> </div>
 ...
 ?>
<img style="margin-left: 30px;"   src=" <?php echo $user->profile_pic; ?>" valign="top" >
 <a class=" hnm" href="<?php echo base_url()?>Users/profile">   <?php echo $user->name; ?> </a> &nbsp; <span class="text-white"> | </span> &nbsp;  <a class="hnm" href="<?php echo base_url()?>Feeds/dashboard"> Account </a>
...
<div id="search_result">
 ...
 <div class="headerIco">
  <a class="opt" href="#" onclick="options();return false;">  <img src="<?php echo base_url(); ?>assets/img/options.png" style="height: 18px;width: 18px;" > </a>
</div>
...
function confirm(fid,uid,cnfrm) {


    $.ajax({

    
    url: '<?php echo base_url() ?>Feeds/friendAccept/'+fid+'/'+uid+'/'+cnfrm,
    type: 'POST', 
    cache: false,
    contentType: false,
    processData: false,
 ...
 {
  $.ajax({
   url:"<?php echo base_url(); ?>Feeds/buyer_request",
   method:"POST",
   data:{view:view},
   dataType:"json",
...
function load_unseen_notification(view = '')
 {
  $.ajax({
   url:"<?php echo base_url(); ?>Feeds/notification",
   method:"POST",
   data:{view:view},
   dataType:"json",
   success:function(data)
...
function search_truevl(){
  ...
  if(input.length>0){
  $.ajax({
    url: "<?php echo base_url(); ?>Feeds/search_truevl",
    method: "POST",
    data: { input: input },
    datatype: "json",
    success: function(response){
