...
<div class="row">
 ...
 <div class="tab">
    ...
    <button class="tablinks" onclick="tabs(event, 'Earning')"> Earning Report </button>
    <button class="tablinks" onclick="tabs(event, 'Promotiona')"> Promotion </button>
    
    <button class="tablinks" onclick="tabs(event, 'Helpa')"> Truevl Help </button>
    <button class="tablinks" onclick="tabs(event, 'Spam')">Spam alert</button>
    <button class="tablinks" onclick="tabs(event, 'Paymentsa')"> Payments </button>
...
<div class="dash" style="margin-top: 40px;">
   <h1 class="tdeading"> Promoted post  </h1> <br> <br>
   <h3> Promoted By Me </h3>
<div style="width: 100%" cellpadding="4px">
   <table  class="" id="tableData" >
     <thead> 
      <tr class="trow">
        <th> <b> Promo Date </b> </th>
    ...
    <?php
      ...
      if(count($promoPosts)==0){ ?>
         <tr>  <td colspan="6"> No record found  </td> </tr> 
      <?php  }  
      else{
      foreach ($promoPosts as $key => $post) {
        if($key < 5){       
        ?>
      ...
      <tr class="trow">
          ...
          <td> 
           ...
           <img src=" <?php echo $post->thumb; ?>" height="40px" width="40px" valign="middle" > 

              <?php }

              ?>
           <?php echo mb_substr($post->post_title, 0,160); ?> </td>
    ...
    <table>
      <thead>
          <tr class="trow">
             ...
             <th>   Category </th>
             <th>   Reach </th>
             <th>   Total Promoter  </th>
             <th>   Total Bidding amount </th>
             <th>   Clicks  </th>
             <th>   Action </th>
          </tr>
     </thead>
  ...
  <div id="Earning" class="tabcontent"  >
    ...
    <div class="dbox">
      ...
      <div>
         <h4 class="text-center" style="margin-top: 25px; margin-bottom: 10px;"> Debit</h4>
         <p class="text-center" style="font-size: 32px; font-weight: 700;"> <i class="fa fa-inr" ></i> 
...
<br>
<br>
      <h1 class="tdeading"> Promote Earning  </h1>

<div style="width: 100%" cellpadding="4px">
   <table  class="" id="tableData3">
      <thead>
          <tr class="trow">
            <th>  Date</th>   
             <th>  Title </th>
    ...
    <?php
      ...
      foreach ($promoPosts as $key => $post) {
        ...
        if($post->post_status==1 && $post->is_status==0){
      ?>
...
<?php if(count(json_decode($dailyPromo))==0){ ?>
        <h1 class="text-center text-gray" style="margin-top: 30px;">
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="42.000000pt" height="42.000000pt" viewBox="0 0 712.000000 688.000000"
 preserveAspectRatio="xMidYMid meet" >
<metadata>
...
<?php  }
    ...
    <p style="margin-top: 15px; margin-bottom: 0px;" class="text-gray"> Today </p>
    <canvas id="myChart11" style="height: 200px;"  height="200px" ></canvas>
<?php } ?>
...
<div style="width: 30%;float: left;">
  ...
  <?php if(count(json_decode($weeklyPromo))==0){ ?>
          <h1 class="text-center text-gray" style="margin-top: 30px;">
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="42.000000pt" height="42.000000pt" viewBox="0 0 712.000000 688.000000"
 preserveAspectRatio="xMidYMid meet" >
...
<?php  }
      ...
      <p style="margin-top: 15px; margin-bottom: 0px;" class="text-gray"> Last 7 days </p>
<canvas id="myChart12" style="height: 200px;"  height="200px" ></canvas>
<?php } ?>
...
<div style="width: 30%;float: left;">
  ...
  <?php if(count(json_decode($monthlyPromo))==0){ ?>
         <h1 class="text-center text-gray" style="margin-top: 30px;">
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="42.000000pt" height="42.000000pt" viewBox="0 0 712.000000 688.000000"
 preserveAspectRatio="xMidYMid meet" >
...
<?php  }
  ...
  <p style="margin-top: 15px; margin-bottom: 0px;" class="text-gray"> Last 30 days </p>
<canvas id="myChart13" style="height: 200px;"  height="200px" ></canvas>
  ...
  <br><br>
   ...
   <div class="row">
      <div id="Promotion" class="tabcontent"  >
        ...
        <div class="dash boxx" style="padding: 10px; width: 95%; margin:2px auto;height: 120px">

        <div style="width: 33%;float: left;">
         <h2 style="color: rgba(0,0,0,0.7);text-align: center;font-size: 16px;">Total Promotion Amount </h2>
         <h3 class="text-center" style="font-size: 32px;"> <?php 
              if($totalPromoSpend->sum==0){ 
                  echo 0;
              }
              else{
             echo  $totalPromoSpend->sum; } ?> </h3> 
          <h3 class="text-center"> Date from <?php echo date("F, Y"); ?> </h3>
        
       </div>

         <div style="width: 33%;float: left;"> 
           <h2 style="color: rgba(0,0,0,0.7);text-align: center;font-size: 16px;">This Month </h2> 
         <h3 class="text-center" style="font-size: 32px;color: rgba(0,0,0,0.7);"> <?php 
          if($monthlyPromoSpend->sum==0){ 
              echo 0; 
          }
          else { 
         echo $monthlyPromoSpend->sum; } ?>
</h3> 
          <h3 class="text-center"> 15 Jan.2018 to 15 Oct.2018  </h3>
       </div>

         <div style="width: 33%;float: left;">
           <h2 style="color: rgba(0,0,0,0.7);text-align: center;font-size: 16px;"> Total Active Duration  </h2> 
         <h3 class="text-center" style="font-size: 32px;color: rgba(0,0,0,0.7);"> 

          <?php 
             
          $date1=date_create($totalTime->joining_date);
          ...
          <h3 class="text-center"> Months </h3>
       </div>
         ...
         <div class="cl"> </div>
            ...
            <div class="dash boxx" style="width: 95%;margin-left: 2%;padding: 10px;" >
    <div style="width: 20%; float: left; border-right: 3px solid #ccc;margin-top: 10px;padding-bottom: 40px;">
      <h3 style="margin-top: 50px;" class="text-center tdeading"> Circulated </h3>
      <h2 class="text-center" style="font-size: 36px;">
          <?php

        if($totalCirculation->sum > 0)
           echo $totalCirculation->sum;
         else
          echo 0;
         ?>  
      </h2>
    ...
    <?php
      if(count(json_decode($monthWisePromoSpend)) ==0)
      { ?>
         <h1 class="text-center text-gray" style="margin-top: 30px;">
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="42.000000pt" height="42.000000pt" viewBox="0 0 712.000000 688.000000"
...
No record found
    ...
    <canvas id="myChartpr" style="height: 80px; "  height="80px" ></canvas>
    ...
    <div class="dash" style="background: #F2F2F2;width: 95%;margin-left: 2%;padding: 2px;">  
     <table  class="" id="tableData5">
      <thead>
          <tr class="trow">
             <th>   Date </th>
             <th>   Title </th>
  ...
  <div id="Help" class="tabcontent">
    ...
    <br>  <br>
       <h1 class="tdeading"> truevl Help  </h1> 
...
<div style="width: 100%" cellpadding="4px">
   <table  class="" id="tableData8" >
      ...
      <tr class="trow">
        <th>   Date </th>
        <th> Case summary </th>
        <th>   Total Collected donation Amount</th>
        <th>  Your Donation </th>    
      </tr>
    </thead>
    <?php
      foreach ($postData as $key => $post) {
        ...
        if($post->post_status==1 && $post->is_status==0 && $post->ptype=="Sell" && isset($post->incocming_balance) && $post->img!=NULL){
      ?>
       ...
       <tr class="trow">
          ...
          <?php } ?>  
            ...
            <?php echo mb_substr($post->post_title, 0,50); ?> </td>
          <td><?php echo mb_substr($post->cat,0,3).".."; ?></td>
         
       
         
          <td>   <?php echo $post->incocming_balance; ?> </td>
        
  
          <td>  <?php echo $post->nlink; ?>  </td>
...
<table width="100%" id="tableData10">
    ...
    if($val["outgoing"]!=0) { ?>
       <tr class="trow">
          ...
          <td width="40%"> <?php echo $postData[0]->post_title; ?>  </td>
           ...
           <?php   if ($val["outgoing"]!=0) { ?>
             <td> <?php echo "-".$val["outgoing"]; ?> </td>
          <?php } ?>
          
       
          <td> <?php echo $val["time"]; ?> </td>
          <td class="text-center"> <?php echo $val["source"]." post"; ?> <?php ?>  </td>  
           </tr>  
...
function askPromotion(id){
    $("#askModal").modal('show');
    $("#am").html(' <button class="btn btn-danger" style="width: 10%; float: right;" data-dismiss="modal" > No </button>          <button class="btn btn-success" onclick="stopPromotion('+id+')" style="width: 10%; float: right; margin-right: 15px;"> Yes </button> ');
}
