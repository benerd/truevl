    ...
    <?php $i=1;
      ...
      <tr>
        ...
        <td>  <?php echo $value->views; ?> </td>  
         <td> <a href="<?php echo $value->short_des; ?>" target="_blank"> View </a> | <a href="#" onclick="ask(<?php echo $value->post_id; ?>);"> Delete </a>  </td>     
      </tr>
     <?php $i++; }
    ?>
</table>
...
<table  border="1" class="" >
    ...
    <?php $i=1;
      ...
      <tr>
        ...
        <td>  <?php echo $value->name; ?> </td>  
        <td>  <?php echo $value->views; ?> </td>  
         <td> <a href="<?php echo $value->short_des; ?>" target="_blank"> View </a> | <a href="#" onclick="recover(<?php echo $value->post_id; ?>);"> Restore </a>  </td>     
      </tr>
     <?php $i++; }
    ?>
</table>
